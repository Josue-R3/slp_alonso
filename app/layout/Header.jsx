    ...
    <header className="header">
      ...
      {isMobile && (
        <nav className={`header-nav-mobile ${menuOpen ? 'open' : ''}`}>
          <Link href="/portfolio" className="nav-link-mobile">Portafolio</Link>
          <Link href="/services" className="nav-link-mobile">Servicios</Link>
          <Link href="/contact" className="nav-link-mobile">Contacto</Link>
          <Link href="/about" className="nav-link-mobile">Acerca de mí</Link>
        </nav>
      )}
    </header>
  );
